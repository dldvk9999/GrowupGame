-- ============================================
-- 128: 전직 10차(최종) 업적 추가 + 5차 업적 "(최종)" 오표기 수정 - 신규 콘텐츠
-- 127에서 전직이 5차->10차로 확장되면서, 기존 'job_tier_5' 업적의 "(최종)" 표기가
-- 더 이상 사실과 다르게 됨. 라벨을 정정하고, 진짜 최종 단계인 'job_tier_10' 업적을 신설.
-- claim_achievement/set_equipped_title 둘 다 반환타입 그대로라 DROP FUNCTION 불필요.
-- ============================================
