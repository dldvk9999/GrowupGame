-- ============================================
-- 083: 전투력 마일스톤 업적 3종 추가 (신규 콘텐츠)
-- claim_achievement에 CASE만 추가, 이미 검증된 fetch_my_combat_power()(PvP/랭킹과
-- 동일한 서버 계산, 장비 보너스 포함)를 그대로 재사용해서 조작 불가능하게 검증함.
...
-- set_equipped_title에도 종말의 위용 칭호 매핑 추가 (반환타입 void, DROP 불필요)
