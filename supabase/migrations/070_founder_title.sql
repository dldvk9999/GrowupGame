-- ============================================
-- 070: "얼리버드"(founder) 업적/칭호 추가 - 신규 콘텐츠
-- 2026-08-01 이전 가입자 전용 특별 칭호. claim_achievement에 CASE 분기만 추가,
-- 반환타입(integer) 그대로라 DROP 불필요.
-- ============================================
...
-- set_equipped_title에도 얼리버드 칭호 매핑 추가 (반환타입 void, DROP 불필요)
