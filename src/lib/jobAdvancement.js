...
export const JOB_TIERS = {
  fire: [
    { tier: 1, level: 30, title: '작열의 전사', statMultiplier: 2.0,
      skill: { id: 'fire_job1', name: '작열 폭발', icon: '💢', type: 'damage', element: 'fire', multiplier: 11.5, cooldown: 6500, description: '1차 전직 전용기' } },
    { tier: 2, level: 60, title: '화염 군주', statMultiplier: 3.5,
      skill: { id: 'fire_job2', name: '멸화의 파도', icon: '🌋', type: 'damage', element: 'fire', multiplier: 14.7, cooldown: 8000, description: '2차 전직 전용기' } },
    { tier: 3, level: 100, title: '멸화의 지배자', statMultiplier: 6.0,
      skill: { id: 'fire_job3', name: '종언의 불꽃', icon: '☀️', type: 'damage', element: 'fire', multiplier: 19.8, cooldown: 10000, description: '3차 전직 전용기' } },
    { tier: 4, level: 140, title: '멸화의 화신', statMultiplier: 10.0,
      skill: { id: 'fire_job4', name: '종말의 불꽃 폭풍', icon: '🔥', type: 'damage', element: 'fire', multiplier: 26.2, cooldown: 12500, description: '4차 전직 전용기' } },
    { tier: 5, level: 180, title: '불꽃의 초월자', statMultiplier: 16.0,
      skill: { id: 'fire_job5', name: '멸망의 업화', icon: '🔥', type: 'damage', element: 'fire', multiplier: 33.9, cooldown: 15500, description: '5차 전직 전용기, 최강의 일격' } },
    { tier: 6, level: 240, title: '멸화의 초월자', statMultiplier: 24.0,
      skill: { id: 'fire_job6', name: '천지개벽의 불꽃', icon: '🔥', type: 'damage', element: 'fire', multiplier: 41.6, cooldown: 18500, description: '6차 전직 전용기' } },
    { tier: 7, level: 300, title: '불꽃의 종언자', statMultiplier: 34.0,
      skill: { id: 'fire_job7', name: '종언의 폭염', icon: '☄️', type: 'damage', element: 'fire', multiplier: 49.9, cooldown: 21500, description: '7차 전직 전용기' } },
    { tier: 8, level: 360, title: '태양을 삼킨 자', statMultiplier: 48.0,
      skill: { id: 'fire_job8', name: '태양 붕괴', icon: '💥', type: 'damage', element: 'fire', multiplier: 58.9, cooldown: 24500, description: '8차 전직 전용기' } },
    { tier: 9, level: 420, title: '업화의 신좌', statMultiplier: 66.0,
      skill: { id: 'fire_job9', name: '업화의 심판', icon: '🌋', type: 'damage', element: 'fire', multiplier: 68.5, cooldown: 27500, description: '9차 전직 전용기' } },
    { tier: 10, level: 480, title: '조율자의 후계자 · 불꽃', statMultiplier: 90.0,
      skill: { id: 'fire_job10', name: '조율자의 불꽃', icon: '👑', type: 'damage', element: 'fire', multiplier: 80.0, cooldown: 31000, description: '10차 전직 전용기, 궁극의 일격' } },
  ],
  water: [
    { tier: 1, level: 30, title: '심연의 전사', statMultiplier: 2.0,
      skill: { id: 'water_job1', name: '해일 강타', icon: '💢', type: 'damage', element: 'water', multiplier: 11.5, cooldown: 6500, description: '1차 전직 전용기' } },
    { tier: 2, level: 60, title: '파도의 지배자', statMultiplier: 3.5,
      skill: { id: 'water_job2', name: '심연의 소용돌이', icon: '🌊', type: 'damage', element: 'water', multiplier: 14.7, cooldown: 8000, description: '2차 전직 전용기' } },
    { tier: 3, level: 100, title: '해왕', statMultiplier: 6.0,
      skill: { id: 'water_job3', name: '태초의 해일', icon: '🌀', type: 'damage', element: 'water', multiplier: 19.8, cooldown: 10000, description: '3차 전직 전용기' } },
    { tier: 4, level: 140, title: '심해의 지배자', statMultiplier: 10.0,
      skill: { id: 'water_job4', name: '대해일의 심판', icon: '🌊', type: 'damage', element: 'water', multiplier: 26.2, cooldown: 12500, description: '4차 전직 전용기' } },
    { tier: 5, level: 180, title: '만해의 지배자', statMultiplier: 16.0,
      skill: { id: 'water_job5', name: '태초의 심연', icon: '🌊', type: 'damage', element: 'water', multiplier: 33.9, cooldown: 15500, description: '5차 전직 전용기, 최강의 일격' } },
    { tier: 6, level: 240, title: '심연의 초월자', statMultiplier: 24.0,
      skill: { id: 'water_job6', name: '천지개벽의 해일', icon: '🌊', type: 'damage', element: 'water', multiplier: 41.6, cooldown: 18500, description: '6차 전직 전용기' } },
    { tier: 7, level: 300, title: '만해의 종언자', statMultiplier: 34.0,
      skill: { id: 'water_job7', name: '종언의 폭풍우', icon: '🌪️', type: 'damage', element: 'water', multiplier: 49.9, cooldown: 21500, description: '7차 전직 전용기' } },
    { tier: 8, level: 360, title: '대양을 삼킨 자', statMultiplier: 48.0,
      skill: { id: 'water_job8', name: '대양 붕괴', icon: '💥', type: 'damage', element: 'water', multiplier: 58.9, cooldown: 24500, description: '8차 전직 전용기' } },
    { tier: 9, level: 420, title: '심해의 신좌', statMultiplier: 66.0,
      skill: { id: 'water_job9', name: '심해의 심판', icon: '🌀', type: 'damage', element: 'water', multiplier: 68.5, cooldown: 27500, description: '9차 전직 전용기' } },
    { tier: 10, level: 480, title: '조율자의 후계자 · 물결', statMultiplier: 90.0,
      skill: { id: 'water_job10', name: '조율자의 파도', icon: '👑', type: 'damage', element: 'water', multiplier: 80.0, cooldown: 31000, description: '10차 전직 전용기, 궁극의 일격' } },
  ],
  grass: [
    { tier: 1, level: 30, title: '숲의 전사', statMultiplier: 2.0,
      skill: { id: 'grass_job1', name: '가시 폭풍', icon: '💢', type: 'damage', element: 'grass', multiplier: 11.5, cooldown: 6500, description: '1차 전직 전용기' } },
    { tier: 2, level: 60, title: '대지의 수호자', statMultiplier: 3.5,
      skill: { id: 'grass_job2', name: '고대수의 분노', icon: '🌳', type: 'damage', element: 'grass', multiplier: 14.7, cooldown: 8000, description: '2차 전직 전용기' } },
    { tier: 3, level: 100, title: '태초의 정령왕', statMultiplier: 6.0,
      skill: { id: 'grass_job3', name: '만물의 개화', icon: '🌸', type: 'damage', element: 'grass', multiplier: 19.8, cooldown: 10000, description: '3차 전직 전용기' } },
    { tier: 4, level: 140, title: '대자연의 화신', statMultiplier: 10.0,
      skill: { id: 'grass_job4', name: '태초의 개화', icon: '🌿', type: 'damage', element: 'grass', multiplier: 26.2, cooldown: 12500, description: '4차 전직 전용기' } },
    { tier: 5, level: 180, title: '태초의 화신', statMultiplier: 16.0,
      skill: { id: 'grass_job5', name: '만물의 근원', icon: '🌿', type: 'damage', element: 'grass', multiplier: 33.9, cooldown: 15500, description: '5차 전직 전용기, 최강의 일격' } },
    { tier: 6, level: 240, title: '태초의 초월자', statMultiplier: 24.0,
      skill: { id: 'grass_job6', name: '천지개벽의 가시', icon: '🌿', type: 'damage', element: 'grass', multiplier: 41.6, cooldown: 18500, description: '6차 전직 전용기' } },
    { tier: 7, level: 300, title: '대지의 종언자', statMultiplier: 34.0,
      skill: { id: 'grass_job7', name: '종언의 폭화', icon: '🌸', type: 'damage', element: 'grass', multiplier: 49.9, cooldown: 21500, description: '7차 전직 전용기' } },
    { tier: 8, level: 360, title: '만물을 삼킨 자', statMultiplier: 48.0,
      skill: { id: 'grass_job8', name: '대지 붕괴', icon: '💥', type: 'damage', element: 'grass', multiplier: 58.9, cooldown: 24500, description: '8차 전직 전용기' } },
    { tier: 9, level: 420, title: '자연의 신좌', statMultiplier: 66.0,
      skill: { id: 'grass_job9', name: '자연의 심판', icon: '🌳', type: 'damage', element: 'grass', multiplier: 68.5, cooldown: 27500, description: '9차 전직 전용기' } },
    { tier: 10, level: 480, title: '조율자의 후계자 · 대지', statMultiplier: 90.0,
      skill: { id: 'grass_job10', name: '조율자의 뿌리', icon: '👑', type: 'damage', element: 'grass', multiplier: 80.0, cooldown: 31000, description: '10차 전직 전용기, 궁극의 일격' } },
  ],
};
