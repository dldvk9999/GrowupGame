/**
 * 뽑기 확률 구간표 - 서버(draw_skill/draw_equipment, 055 기준)의 확률 로직을
 * 그대로 미러링한 것. 스킬뽑기와 장비뽑기가 동일한 구간/확률을 공유함(055에서 확인).
 * 실제 판정은 항상 서버가 하므로, 여기는 순수 "안내용 표시"일 뿐 로직에 관여하지 않음.
 * ⚠️ 서버의 draw_skill/draw_equipment 확률을 바꾸는 마이그레이션을 만들 때는
