 ...
 * 원래 레벨 상한이 100일 때는 다음 등급의 "1레벨 기본값"을 못 넘도록 성장폭을 작게 잡았었음
 * (등급 간 base가 ×1.4씩 벌어져 있고, 레벨100 최대 성장폭은 ×1.297).
 * 상한을 1000으로 올리면서 수식은 그대로 유지 — 레벨1000 최대 성장폭은 ×3.297까지 커져서
 * 다음 등급 기본값을 넘어설 수 있음(의도된 변경).
 */
