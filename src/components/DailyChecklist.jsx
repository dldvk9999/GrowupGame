 ...
 */
export default function DailyChecklist({ attendanceClaimedToday, freeDrawUsed, missionCompleted, worldBossAttempted, dungeonAttempted, onOpenAttendance, onOpenShop, onOpenWorldBoss, onOpenDungeon }) {
  const items = [
