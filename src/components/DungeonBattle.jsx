    ...
    <div className={`battle-screen ${shake ? 'shake' : ''}`}>
      ...
      <div className="arena">
        ...
        <div className="fighter-slot fighter-slot--player">
          <MonsterSprite speciesKey={getDisplaySpriteKey(player.speciesId, player.element, player.unlockedJobTier ?? 0)} size={110} alt={player.name} costumeKeys={equippedCostumes} dungeonTheme={dungeonEnemy.dungeonType} />
