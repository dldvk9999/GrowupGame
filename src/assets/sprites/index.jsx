...
export const spriteRegistry = {
  ...
  fire_job6: (props) => <JobTierSprite element="fire" tier={6} {...props} />,
  water_job6: (props) => <JobTierSprite element="water" tier={6} {...props} />,
  grass_job6: (props) => <JobTierSprite element="grass" tier={6} {...props} />,
  fire_job7: (props) => <JobTierSprite element="fire" tier={7} {...props} />,
  water_job7: (props) => <JobTierSprite element="water" tier={7} {...props} />,
  grass_job7: (props) => <JobTierSprite element="grass" tier={7} {...props} />,
  fire_job8: (props) => <JobTierSprite element="fire" tier={8} {...props} />,
  water_job8: (props) => <JobTierSprite element="water" tier={8} {...props} />,
  grass_job8: (props) => <JobTierSprite element="grass" tier={8} {...props} />,
  fire_job9: (props) => <JobTierSprite element="fire" tier={9} {...props} />,
  water_job9: (props) => <JobTierSprite element="water" tier={9} {...props} />,
  grass_job9: (props) => <JobTierSprite element="grass" tier={9} {...props} />,
  fire_job10: (props) => <JobTierSprite element="fire" tier={10} {...props} />,
  water_job10: (props) => <JobTierSprite element="water" tier={10} {...props} />,
  grass_job10: (props) => <JobTierSprite element="grass" tier={10} {...props} />,
};
