...
기존 테마 컬러 선택(5종, 누구나 즉시 사용 가능)에 더해, **특정 성취를 달성해야 쓸 수 있는 특별 테마 3종**을 추가함 — 업적/PvP 시스템과 개인화(테마) 시스템을 연결하는 콘텐츠:
