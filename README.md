...
- **다 같이 용을 팬다** — 매주 전체 유저가 체력 하나를 공유하는 월드보스가 등장해요. 하루 3번씩 부지런히 깎아서 일주일 안에 처치하면, 참여한 사람 전원한테 7일짜리 "용의 버프"(공격력·방어력 20배!)가 붙고 닉네임이 무지개색으로 반짝여요. 못 잡으면? 그래도 깎은 만큼 골드는 챙겨드려요.
